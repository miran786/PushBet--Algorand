...
export function AssetArena() {
    ...
    // Return/Lender State
    const [returnStep, setReturnStep] = useState<"scanning" | "verifying" | "success">("scanning");
        ...
        try {
            ...
            if (!isTrusted) {
                const payTxn = algosdk.makePaymentTxnWithSuggestedParamsFromObject({
                    ...
                    receiver: appAddr,
                    amount: algosdk.algosToMicroalgos(5), // Fixed 5 ALGO for demo
                            ...
                            <div key={item.id} className="flex items-center justify-between p-6 bg-gray-800 rounded-2xl border border-gray-700 hover:border-gray-500 transition-all">
                                ...
                                <div className="text-right">
                                    <div className="text-sm text-gray-400 mb-2">
                                        Collateral: {isTrusted ? <span className="line-through text-gray-600">50 ALGO</span> : <span className="text-[var(--electric-volt)]">50 ALGO</span>}
